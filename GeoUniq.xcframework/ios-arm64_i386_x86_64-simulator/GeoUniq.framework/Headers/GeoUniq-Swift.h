...
#ifndef GEOUNIQ_SWIFT_H
#define GEOUNIQ_SWIFT_H
...
typedef SWIFT_ENUM(NSInteger, ConsentItem, open) {
...
typedef SWIFT_ENUM(NSInteger, CustomEndpointException, open) {
...
typedef SWIFT_ENUM(NSInteger, GUError, open) {
...
/// time of the location
@property (nonatomic, copy) NSDate * _Nonnull confirmedAt;
...
typedef SWIFT_ENUM(NSInteger, GUMotionType, open) {
/// Not Moving
///
/// returns:
/// not moving activity
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, GUSort, open) {
...
- (void)setConsentStatusWithIsGranted:(BOOL)isGranted SWIFT_DEPRECATED_MSG("", "setPrivacyConsent:value:");
...
SWIFT_CLASS("_TtC7GeoUniq17GuSessionDelegate")
@interface GuSessionDelegate : NSObject
...
@interface GuSessionDelegate (SWIFT_EXTENSION(GeoUniq)) <NSURLSessionDownloadDelegate>
...
@interface GuSessionDelegate (SWIFT_EXTENSION(GeoUniq)) <NSURLSessionStreamDelegate>
...
@interface GuSessionDelegate (SWIFT_EXTENSION(GeoUniq)) <NSURLSessionDelegate>
...
@interface GuSessionDelegate (SWIFT_EXTENSION(GeoUniq)) <NSURLSessionDataDelegate>
...
@interface GuSessionDelegate (SWIFT_EXTENSION(GeoUniq)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC7GeoUniq15PersistenceBool")
@interface PersistenceBool : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq21PersistenceCLLocation")
@interface PersistenceCLLocation : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq15PersistenceDate")
@interface PersistenceDate : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq17PersistenceDouble")
@interface PersistenceDouble : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq22PersistenceGUDetection")
@interface PersistenceGUDetection : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq24PersistenceIncremetalInt")
@interface PersistenceIncremetalInt : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq14PersistenceInt")
@interface PersistenceInt : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq29PersistenceOptionalCLLocation")
@interface PersistenceOptionalCLLocation : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq32PersistenceOptionalPositionModel")
@interface PersistenceOptionalPositionModel : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq30PersistenceRegionConfiguration")
@interface PersistenceRegionConfiguration : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7GeoUniq17PersistenceString")
@interface PersistenceString : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
